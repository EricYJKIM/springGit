	...
	<div class="container p-3 col-12"
		...
		<div class="files">
			...
			<c:forEach var="f" items="${flist}">
				<a	href="/board/detail?file_seq=${f.seq}&oriName=${f.oriName}&sysName=${f.sysName}">${f.oriName}</a>
		...
		<div class="btn_wrap" align="right">
			<c:choose>
				<c:when test="${loginID eq list.id}">
					<a href="/board/modifyForm?board_seq=${list.board_seq}"
	...
	<div id="boardDeleteForm" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				<form action="/board/delete?board_seq=${list.board_seq}"
					method="post">
